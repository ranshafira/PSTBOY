        ...
        <div class="space-y-8">
            ...
            <div class="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                ...
                <div class="text-center mb-6">
                    <p class="{{ $antrianBerjalan ? 'text-3xl font-bold text-orange-500' : 'text-2xl font-semibold text-gray-400' }}">
                        {{ $antrianBerjalan->nomor_antrian ?? 'Tidak ada' }}
                    </p>
                    <p class="text-sm {{ $antrianBerjalan ? 'text-gray-500' : 'text-gray-400' }}">
                        Nomor Antrian Aktif
                    </p>
                </div>
                ...
                <div class="space-y-2 text-sm text-gray-800">
                    <div class="flex justify-between">
                        ...
                        <span>{{ $totalAntrianHariIni }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Sudah Dilayani:</span>
                        <span>{{ $sudahDilayani }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Buku Tamu:</span>
                        <span>{{ $bukuTamuCount }}</span>
                    </div>
                </div>
            </div>
