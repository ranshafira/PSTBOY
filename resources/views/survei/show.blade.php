...
<div class="antialiased bg-gray-50 min-h-screen py-8 md:py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-5 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-8">
            <div>
                <p class="font-medium text-gray-500">Pengunjung</p>
                <p class="font-semibold text-base text-gray-800 truncate">{{ $pelayanan->nama_pengunjung }}</p>
            </div>
            <div>
                <p class="font-medium text-gray-500">No. Antrian</p>
                <p class="font-semibold text-base text-gray-800">{{ $pelayanan->antrian->nomor_antrian }}</p>
            </div>
            <div>
                <p class="font-medium text-gray-500">Durasi</p>
                <p class="font-semibold text-base text-gray-800">{{ $pelayanan->waktu_selesai_sesi ? $pelayanan->waktu_selesai_sesi->diffInMinutes($pelayanan->waktu_mulai_sesi) : '-' }} menit</p>
            </div>
            <div>
                <p class="font-medium text-gray-500">Jenis Layanan</p>
                <p class="font-semibold text-base text-gray-800 truncate">{{ $pelayanan->jenisLayanan->nama_layanan }}</p>
            </div>
        </div>
