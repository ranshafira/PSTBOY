        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden sm:flex items-center space-x-6 text-sm font-medium">
                <a href="{{ route('admin.dashboard') }}"
                   class="{{ request()->routeIs('admin.dashboard') ? 'text-orange-500 font-semibold' : 'text-gray-700 hover:text-orange-500 transition' }}">
                    Dashboard
                </a>
                <a href="{{ route('admin.petugas.index') }}"
                   class="{{ request()->routeIs('admin.petugas.*') ? 'text-orange-500 font-semibold' : 'text-gray-700 hover:text-orange-500 transition' }}">
                    Petugas PST
                </a>
                <a href="{{ route('admin.jadwal.index') }}"
                   class="{{ request()->routeIs('admin.jadwal.*') ? 'text-orange-500 font-semibold' : 'text-gray-700 hover:text-orange-500 transition' }}">
                    Jadwal
                </a>
