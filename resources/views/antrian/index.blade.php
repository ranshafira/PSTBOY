    ...
    <header class="bg-bps-dark shadow-md">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center">
                ...
                <strong class="text-lg hidden sm:block">BPS Kabupaten Boyolali</strong>
            </div>
            <nav class="flex items-center gap-4">
                <a href="#" class="text-sm hover:text-gray-300 hidden md:block">Layanan</a>
                <a href="#" class="text-sm hover:text-gray-300 hidden md:block">Kontak</a>
                <button class="bg-white text-bps-dark rounded-full px-4 py-1.5 text-sm font-semibold hover:bg-bps-orange hover:text-white transition-colors duration-300">
                    Masuk/Daftar
                </button>
            </nav>
        </div>
