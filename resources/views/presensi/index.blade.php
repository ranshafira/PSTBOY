            ...
            <div class="flex items-center space-x-8 mb-4">
                <div>
                    ...
                    <p class="font-bold text-xl">
                        @if($presensiHariIni && $presensiHariIni->waktu_datang)
                        {{ \Carbon\Carbon::parse($presensiHariIni->waktu_datang)->format('H:i:s') }}
                        @else
                        -
                        @endif
                    </p>
                ...
                <div>
                    ...
                    <p class="font-bold text-xl">
                        ...
                        {{ \Carbon\Carbon::parse($presensiHariIni->waktu_pulang)->format('H:i:s') }}
                        @else
                        -
                        @endif
                    </p>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="p-3">
                                ...
                                {{ \Carbon\Carbon::parse($presensi->waktu_datang)->format('H:i:s') }}
                                @else
                                -
                                @endif
                            </td>
                            <td class="p-3">
                                ...
                                {{ \Carbon\Carbon::parse($presensi->waktu_pulang)->format('H:i:s') }}
                                @else
                                -
                                @endif
                            </td>
                            <td class="p-3">
                                ...
                                @php
                                $jamKerja = \Carbon\Carbon::parse($presensi->waktu_datang)->diffInHours(\Carbon\Carbon::parse($presensi->waktu_pulang));
                                $menitKerja = \Carbon\Carbon::parse($presensi->waktu_datang)->diffInMinutes(\Carbon\Carbon::parse($presensi->waktu_pulang)) % 60;
                                @endphp
    ...
    <div class="space-y-8">
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 text-center">
            ...
            <div class="text-sm space-y-2">
                ...
                <div class="flex justify-between"><span>Total Terjadwal:</span> <span class="font-semibold">{{ $statistik['total_hari'] }} hari</span></div>
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <ul class="text-sm text-gray-600 list-disc list-inside space-y-2">
                ...
                <li>Presensi hanya diperbolehkan pada hari terjadwal</li>
            </ul>
        </div>
    </div>
</div>
